...
if($countrowshdls==1){
 $columDefinition= colDefinition($data);
	...
	if($countrowshdls>1){
        ...
        if($phoneNumber){
           insertMsg('sms_msgqueue',$msgct,$phoneNumber,$commtype);
        } else{
             insertMsg('sms_msginvalid',$msgct,$phone_number,$commtype);
        }
...
if($countrowshdls==1){
 $columDefinition= colDefinition($data);
	...
	if($countrowshdls>1){
	    ...
	    if($phoneNumber){
              if($phoneNumber){
           insertMsg('sms_msgqueue',$msgct,$phoneNumber,$scheduleId);
        } else{
             insertMsg('sms_msginvalid',$msgct,$phone_number,$scheduleId);
        }
